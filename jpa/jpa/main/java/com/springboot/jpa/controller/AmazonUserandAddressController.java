...
public class AmazonUserandAddressController {
	...
	public  ResponseEntity<Void> creatorder(@RequestBody Order order)
	{
		...
		return new ResponseEntity<Void>(
				amazonUserandAddService.creatorder(order)? HttpStatus.CREATED:HttpStatus.INTERNAL_SERVER_ERROR);
	}
	/*
	 * PostMapping("/createcompayId") public ResponseEntity<Void>
	 * createCompayId(@RequestBody CompanyId companyId) {
	 * 
	 * return new ResponseEntity<Void>( companyService.createCompayId(companyId) ?
